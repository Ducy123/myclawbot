...
description: "Transform agents from passive task-followers into proactive, persistent, self-improving operators. Use when setting up or improving an agent that should anticipate needs, maintain continuity across sessions, use write-ahead logging and working buffers, recover from compaction/context loss, run proactive heartbeats or autonomous crons, and follow battle-tested patterns for memory, security, and self-improvement."
---
